...
import (
	...
	scheme "github.com/projectcalico/cni-plugin/pkg/k8s/generated/clientset/versioned/scheme"
...
// ServiceIPPoolsGetter has a method to return a ServiceIPPoolInterface.
// A group's client should implement this interface.
type ServiceIPPoolsGetter interface {
	ServiceIPPools(namespace string) ServiceIPPoolInterface
}
...
// serviceIPPools implements ServiceIPPoolInterface
type serviceIPPools struct {
	client rest.Interface
	ns     string
}

// newServiceIPPools returns a ServiceIPPools
func newServiceIPPools(c *ServiceippoolV1alpha1Client, namespace string) *serviceIPPools {
	return &serviceIPPools{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *serviceIPPools) List(opts v1.ListOptions) (result *v1alpha1.ServiceIPPoolList, err error) {
	...
	result = &v1alpha1.ServiceIPPoolList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("serviceippools").
